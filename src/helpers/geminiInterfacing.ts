...
import type {ParsedElementInfo} from "@streamparser/json/src/utils/types/parsedElementInfo";
...
async function asyncRequestAndParse(requestData: GenerateContentRequest, jsonPaths: Array<string>, onValueCallback: (info: ParsedElementInfo) => void) {
